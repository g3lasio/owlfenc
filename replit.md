...
- **PDF Template System**: **SIMPLIFIED TO 2 OPTIONS (August 2025)** - Streamlined template selection with only "Básico" (free, using estimate-template-free.html) and "Premium" (paid, using estimate-template-premium.html). Premium template features sumamente profesional design with detailed sections, professional header with accent gradients, comprehensive client information layout, advanced materials table, detailed terms & conditions, signature sections, and corporate-quality styling without luxury elements.
