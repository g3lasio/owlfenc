...
export const securityHeaders = helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://maps.googleapis.com", "https://api.mapbox.com", "https://clerk.dev", "https://*.clerk.accounts.dev", "https://*.clerk.com"],
      imgSrc: ["'self'", "data:", "https:", "blob:"],
      connectSrc: ["'self'", "https://api.openai.com", "https://api.anthropic.com", "https://api.stripe.com", "https://firestore.googleapis.com", "https://identitytoolkit.googleapis.com", "https://clerk.dev", "https://*.clerk.accounts.dev", "https://*.clerk.com", "wss:"],
      frameSrc: ["'self'", "https://js.stripe.com", "https://clerk.dev", "https://*.clerk.accounts.dev"],
      objectSrc: ["'none'"],
