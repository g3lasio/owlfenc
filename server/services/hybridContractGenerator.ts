...
<div class="bullet-point">• ${contractData.project.description}</div>
...
<div class="bullet-point">• The first payment will be after signed contract (30% as upfront cost)</div>
<div class="bullet-point">• The final payment when the project is completed</div>
