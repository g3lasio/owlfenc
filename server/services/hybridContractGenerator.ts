...
if (!process.env.ANTHROPIC_API_KEY) {
      if (process.env.NODE_ENV === 'production') {
        throw new Error('ANTHROPIC_API_KEY no está configurada en producción');
      } else {
        console.warn('⚠️ ANTHROPIC_API_KEY not set in hybridContractGenerator. Using a mock for development.');
        this.anthropic = {
          messages: {
