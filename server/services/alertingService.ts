...
export class AlertingService {
      ...
      attachments: [
        {
          ...
          footer: 'Owl Fence AI Alerting System',
      ...
      embeds: [
        {
          ...
          timestamp: new Date().toISOString(),
          footer: {
            text: 'Owl Fence AI Alerting System'
          }
        }
      ]
    };
  ...
  private async sendEmailAlert(alert: Alert): Promise<void> {
    ...
    const { data, error } = await resend.emails.send({
      from: 'Owl Fence AI Alerts <alerts@owlfenc.com>',
    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This alert was generated by the Owl Fence AI monitoring system.</p>
