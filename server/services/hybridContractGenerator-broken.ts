...
<body data-contractor="${contractorNameForFooter}" data-date="${currentDate}">
    ...
    <div class="signature-section" style="display: flex; gap: 20px; margin-top: 20px;">
  ...
  /**
   * Generate enhanced fallback HTML template with compact design and professional pagination
   */
  private generateEnhancedFallbackHTML(contractData: ContractData, contractorBranding: any): string {
            border: 2px solid #000;
            padding: 15px;
