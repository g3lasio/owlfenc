...
router.post('/api/process-estimate-pdf', upload.single('estimate'), async (req: Request, res: Response) => {
  try {
...
router.post('/api/anthropic/generate-defensive-contract', async (req: Request, res: Response) => {
  try {
