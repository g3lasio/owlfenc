        ...
        if (projectData.projectTotalCosts?.materialCosts?.items) {
          estimateItems = projectData.projectTotalCosts.materialCosts.items.map(
            (item: any, index: number) => {
              ...
              const price =
                Math.abs(calculatedTotal - totalInDollars) < 1
                  ? priceInDollars
                  : rawPrice;
              const total =
                Math.abs(calculatedTotal - totalInDollars) < 1
...
*"Your project, our passion. Quality guaranteed."*`,
  ...
  //   }
  // };
  const randomSixDigit = String(Math.floor(Math.random() * 1000000)).padStart(
    6,
    "0",
  );
  ...
  const downloadPDF = async () => {
    const payload = {
      company_logo_url: "",
      //@ts-ignore
      company_name: estimate?.client?.name_1,

      //@ts-ignore
      company_address: estimate?.client?.address,
      ...
      estimate_date:
        estimate?.client?.createdAt instanceof Date
          ? estimate.client.createdAt.toISOString().split("T")[0]
          : "",
      estimate_number: "EST-" + randomSixDigit,
    };
      ...
      <Dialog open={showEmailDialog} onOpenChange={setShowEmailDialog}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader className="border-b border-gray-200 pb-4">
            ...
            <DialogDescription className="text-gray-600 mt-2">
              Send your professional estimate directly to the client with a
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="text-gray-900">
                      {estimate.projectDetails || "No description"}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  <Label
                    htmlFor="message"
                    className="text-sm font-medium text-gray-700 flex items-center gap-2 mb-2"
                  >
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This message will be included in the email along with your
                    estimate
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
              ...
              <div className="bg-white border rounded-lg p-4 text-sm">
                <div className="border-b pb-2 mb-3">
                  ...
                  <p>
                    <strong>From:</strong> {profile?.email || "your@email.com"}
                  </p>
                  <p>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 border border-cyan-500/20">
              <div className="space-y-2 text-sm">
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  <span className="text-cyan-300 font-medium min-w-12">
                    To:
                  </span>
