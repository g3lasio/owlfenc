...
// State map: display label → 2-letter code (matches Profile page SelectItem values)
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  {US_STATES.map(s => (
                    <option key={s.value} value={s.value} className="bg-slate-800">{s.label} ({s.value})</option>
                  ))}
                </select>
