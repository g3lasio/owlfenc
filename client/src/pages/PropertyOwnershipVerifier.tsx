        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-6 pt-4 border-t">
              <h3 className="text-md font-semibold mb-2">¡Ey Primo! Esto es lo que debes saber:</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-start bg-blue-50 p-3 rounded-lg border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">Tú eres un profesional - no te dejes engañar por intermediarios. ¡Tu trabajo vale lo que cobras!</p>
                  </div>
                </li>
              </ul>
            </div>
