              ...
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div className="text-center py-4">
                  <div className="text-sm text-slate-600 mb-2">
                    Conversando con IA para refinar estimado
                  </div>
                ...
                {/* Botón aplicar cambios - Visible después de que la IA responda */}
                {(hasChanges || messages.length > 1) && (
                  <div className="space-y-3 bg-green-50 rounded-lg p-4 border border-green-200">
                    ...
                    <Button 
                      ...
                      className="w-full bg-green-600 hover:bg-green-700 text-white shadow-lg text-sm sm:text-base py-3 transition-all"
                    >
                      <CheckCircle2 className="mr-2 h-4 w-4" />
                      Aplicar Cambios & Cerrar
                    </Button>
                    <div className="text-xs text-green-600 text-center">
                      O continúa la conversación para más ajustes
                    </div>
                  </div>
                )}

                {/* Mensaje de instrucciones si no hay conversación */}
                {messages.length <= 1 && (
                  <div className="text-center py-6 px-4">
                    <div className="text-sm text-slate-600 mb-3">
                      💬 Haz tu solicitud para refinar el estimado
                    </div>
                    <div className="text-xs text-slate-500 space-y-1">
                      <div>• "Que el total sea $13,000"</div>
                      <div>• "Agregar materiales faltantes"</div>
                      <div>• "Reducir precios para mi zona"</div>
                    </div>
                  </div>
                )}
              </CardContent>
