...
import { Pen, RotateCcw, Check, AlertCircle, Smartphone, Monitor } from 'lucide-react';
    ...
    <Card className={`cyberpunk-border ${className}`}>
      <CardHeader className="pb-3">
        ...
        <p className="text-sm text-gray-400">
          {signerName} - {deviceType === 'mobile' ? 'Use su dedo para firmar' : 'Use el mouse para firmar'}
        </p>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {hasSignature && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
            ...
            <div className="bg-gray-800 p-2 rounded">
              ...
              <div className="text-cyan-400 font-mono capitalize">{deviceType}</div>
            </div>
          </div>
        )}
        ...
        {!isReadOnly && (
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={!hasSignature || signatureQuality === 'poor'}
        ...
        {/* Quality Warning */}
        {hasSignature && signatureQuality === 'poor' && (
