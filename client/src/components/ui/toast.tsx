...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[100] flex flex-col p-3 sm:max-w-[320px] w-full sm:w-auto",
      className
    )}
    {...props}
  />
