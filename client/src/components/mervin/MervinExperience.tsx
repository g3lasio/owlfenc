...
export function MervinExperience({ mode, onMinimize, isMinimized = false, onClose }: MervinExperienceProps) {
  ...
  return (
    <div className={containerClass}>
      ...
      <div className="px-3 py-2 border-b border-cyan-900/30 bg-black sticky top-0 z-40 flex-shrink-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            />
            <h1 className="text-sm font-semibold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent whitespace-nowrap">
              Mervin AI
            </h1>
          </div>
