/**
 * Script para crear plantillas de estimados profesionales en la base de datos
 */
const { db } = require('../server/db');
const { templates } = require('../shared/schema');
const { eq, and } = require('drizzle-orm');

async function createProfessionalTemplates() {
  try {
    console.log('Iniciando creación de plantillas profesionales...');
...
module.exports = { createProfessionalTemplates };